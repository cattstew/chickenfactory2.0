...
import java.util.*;
public class Home {
/*Hello mr.espi! We are a evil factory owned by kat the evil boss. Could you help us find the reason why we are unable to escape from the company TT. 
							...
							while(repeat1) {
								...
								if(continueShop1==1) {
									...
									if(cartTotal<deposit){
										System.out.println("You know what we do with people that aren't able to pay for the things they buy?"
												+ "YOU WILL SEE SOON!MUAHAHAHAHAHAAHAHAHAH");
					...
					//------Customer refuses to shop and comply. Let's see if we can get them trapped in our factory forever
						if(scanner.nextInt()==2) {
							if(deposit>cartTotal) {
								System.out.println("Transaction is accepted. You are free to go. Thank you for visiting.");
							}else if(deposit<cartTotal) {
